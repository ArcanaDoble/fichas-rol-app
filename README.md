...
- **Formas personalizables**: cambia cada nodo entre panel suavizado, círculo o triángulo desde el panel lateral o el menú flotante, con estilos y resaltados adaptados a cada figura.

...
- **Alineación de Estilo de Cargas Modulares y Pintado de Color**:
  ...
  - Ajustamos los tamaños de los rombos: el central conserva su escala destacada (`70px`), mientras que los otros cuatro se adaptan a la mitad exacta de su tamaño (`35px`).

...
- **Memoria de exploración por jugador** - Las áreas exploradas se fusionan con la visión actual, se guardan en `pages/<id>/exploration` y aparecen como niebla tenue bajo la oscuridad; el máster puede limpiar, revelar o compartir la memoria con jugadores concretos desde el panel del mapa

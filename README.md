...
- **Límite de Zoom Out Seguro**: Se aumentó el límite mínimo de zoom del 10% al **25%** (`0.25`) para evitar que el navegador móvil (WebKit/Chrome) descarte capas de composición por falta de memoria gráfica en mapas gigantes de `12000px`, eliminando el parpadeo y la desaparición de elementos de la interfaz en zooms alejados.

...
- **Compatibilidad reforzada** con Pixi v8 evitando dependencias cruzadas de `@pixi/*` que rompían pixi-viewport y configurando los brillos con valores nativos de mezcla y filtrado.

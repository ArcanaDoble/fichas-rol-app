...
- **Talento inicial editable** en la pestaña de Equipación con nombre, descripción y selector de rareza (Común, P. Común, Épica, Legendaria) que ajusta los colores del distintivo al vuelo.
- **Marco del retrato depurado** en la vista de resumen, eliminando adornos dorados superpuestos para que el borde se vea limpio.

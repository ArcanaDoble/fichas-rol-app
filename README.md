...
- **Variante Pixi del Mapa de Batalla** - Implementada con `@pixi/react`, mantiene todas las herramientas del canvas clásico y añade renderizado acelerado accesible desde el menú del máster

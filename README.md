...
- **Fichas de recurso en Tablero** - Añade marcadores circulares compactos en 3D real con valor y color editable para representar costes, recuperación de velocidad u otros recursos sandbox directamente sobre la mesa; los tableros suman su valor y las arrastran consigo al moverlos.
- **Dados 3D en Tablero** - Permite generar dados D4, D6, D8, D10, D12 y D20 como objetos independientes, con color editable, caras numeradas, tamaño inicial de 0.75 casillas y modo alternable para moverlos libremente o lanzarlos por gesto de tensión.
